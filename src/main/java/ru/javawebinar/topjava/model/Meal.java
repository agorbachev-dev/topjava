...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.GET_ALL_FILTERED, query = "SELECT m FROM Meal m WHERE m.user.id=:userId  AND m.dateTime >=: startDateTime AND m.dateTime <: endDateTime ORDER BY m.dateTime DESC"),
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String GET_ALL_FILTERED = "Meals.getBetweenHalfOpen";
