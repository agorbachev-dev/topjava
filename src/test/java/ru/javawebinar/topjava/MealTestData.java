...
public class MealTestData {
    ...
    public static final List<Meal> MEALS_BETWEEN_WITHOUT_NULL_PARAMS = List.of(MEAL7, MEAL6, MEAL5, MEAL4);
    public static final LocalDateTime START_DATETIME_WITHOUT_NULL_PARAMS = of(2020, Month.JANUARY, 31, 0, 0);
    public static final LocalDateTime END_DATETIME_WITHOUT_NULL_PARAMS = of(2020, Month.JANUARY, 31, 23, 59);
